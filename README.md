...
[![Tests](https://img.shields.io/badge/tests-197%20passing-brightgreen?logo=checkmarx&logoColor=white)](#tests)
...
- **JWT Authentication** — multi-user with isolated workspaces, bcrypt + optional TOTP 2FA
