...
_BRANCHE = [
    ...
    # ── Dienstleistung / Digital (weitere) ──
    "Online-Marketing-Agentur",
    "Filmproduktion / Videografie",
    "Druckerei",
    "Verlag / Medien",
    "Übersetzungsbüro",
    "Callcenter",
...
SYNONYMS: dict[str, str] = {
    ...
    "malt.de": "Malt",
    "wlw": "wlw / Wer liefert was",
    "wer liefert was": "wlw / Wer liefert was",
    "gulp.de": "Gulp",
