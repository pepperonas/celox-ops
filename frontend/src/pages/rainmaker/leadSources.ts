...
export interface SourceBadge {
  ...
  /** Optionales Icon — steht NICHT im Label, damit der Text les- und suchbar bleibt. */
  icon?: IconName
}
...
export function sourceBadge(source: string | null | undefined): SourceBadge {
  ...
  if (s.includes('ki-recherche') || s.includes('ki ')) {
    return { label: 'KI', color: '#b3c5ff', icon: 'sparkle' }
  }
