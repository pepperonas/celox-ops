    ...
    <div>
      ...
      <div className="bg-surface border border-border rounded-card p-5 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            <p className="text-xs text-text-muted mb-2">Betrag</p>
            <p className="text-text">{formatCurrency(order.amount)}</p>
          </div>
          {order.hourly_rate > 0 && (
            <div>
              <p className="text-xs text-text-muted mb-2">Stundensatz</p>
          ...
          {order.valid_until && (
            <div>
              <p className="text-xs text-text-muted mb-2">Gültig bis</p>
